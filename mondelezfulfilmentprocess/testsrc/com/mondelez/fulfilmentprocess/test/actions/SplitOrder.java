 ...
 */
package com.mondelez.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MondelezFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MondelezFulfilmentProcessConstants.PARENT_PROCESS);
