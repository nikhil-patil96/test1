 ...
 */
package com.mondelez.secureportal.controllers;
...
import com.mondelez.secureportal.constants.MondelezsecureportalWebConstants;
...
import com.mondelez.secureportal.forms.RegistrationForm;
 ...
 * services
 */
@RequestMapping(value = MondelezsecureportalWebConstants.RequestMappings.ACCOUNT_REGISTRATION)
public class B2BRegistrationController extends AbstractB2BRegistrationController
{
	...
	{
		return MondelezsecureportalWebConstants.Views.REGISTRATION_PAGE;
	}

	@Override
	protected String getRegistrationCmsPage()
	{
		return MondelezsecureportalWebConstants.CMS_REGISTER_PAGE_NAME;
	}
	...
	{
		return MondelezsecureportalWebConstants.Views.LOGIN_PAGE;
	}
