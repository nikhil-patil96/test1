 ...
 */
package com.mondelez.secureportal.workflows;
...
import com.mondelez.secureportal.services.B2BRegistrationService;
...
public class B2BRegistrationWorkflowIntegrationTest extends WorkflowIntegrationTest
{
	...
	{
		importCsv("/mondelezsecureportal/test/testCatalog.csv", "UTF-8");
		importCsv("/mondelezsecureportal/test/testdata.csv", "UTF-8");
