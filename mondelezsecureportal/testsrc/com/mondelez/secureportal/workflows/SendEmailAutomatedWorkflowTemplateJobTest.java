...
import com.mondelez.secureportal.model.B2BRegistrationProcessModel;
import com.mondelez.secureportal.workflows.actions.SendEmailAutomatedWorkflowTemplateJob;
	...
	public void callPerformWithNoCustomerModel()
	{
		...
		Mockito.when(
				workflowAttachmentService.getAttachmentsForAction(workflowActionModel,
						"com.mondelez.secureportal.model.B2BRegistrationModel")).thenReturn(b2bRegistrationModelList);
