 ...
 */
package com.mondelez.secureportal.jalo;

import de.hybris.platform.core.Registry;
import com.mondelez.secureportal.constants.MondelezsecureportalConstants;
...
/**
 * This is the extension manager of the Mondelezsecureportal extension.
 */
public class MondelezsecureportalManager extends GeneratedMondelezsecureportalManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MondelezsecureportalManager.class.getName());
	 ...
	 */
	public static MondelezsecureportalManager getInstance()
	{
		return (MondelezsecureportalManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MondelezsecureportalConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MondelezsecureportalManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MondelezsecureportalManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MondelezsecureportalManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MondelezsecureportalManager called, current tenant: " + getTenant().getTenantID());
		}
	}
