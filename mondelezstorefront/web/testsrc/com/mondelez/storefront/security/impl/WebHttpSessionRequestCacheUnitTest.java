...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mondelezstorefront/electronics/en",
						"https://electronics.local:9002/mondelezstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mondelezstorefront/electronics/en",
						"https://electronics.local:9002/mondelezstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mondelezstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mondelezstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mondelezstorefront/electronics/en",
						"https://electronics.local:9002/mondelezstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mondelezstorefront",
						"https://electronics.local:9002/mondelezstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mondelezstorefront",
						"https://electronics.local:9002/mondelezstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mondelezstorefront/electronics/en",
						"https://electronics.local:9002/mondelezstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
