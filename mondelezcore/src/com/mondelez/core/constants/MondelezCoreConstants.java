 ...
 */
package com.mondelez.core.constants;

/**
 * Global class for all MondelezCore constants. You can add global constants for your extension into this class.
 */
public final class MondelezCoreConstants extends GeneratedMondelezCoreConstants
{
	public static final String EXTENSIONNAME = "mondelezcore";


	private MondelezCoreConstants()
	{
		//empty
	}
