...
<%@ taglib prefix="sptemplate" tagdir="/WEB-INF/tags/addons/mondelezsecureportal/responsive/sptemplate"%>
<%@ taglib prefix="spuser" tagdir="/WEB-INF/tags/addons/mondelezsecureportal/responsive/spuser"%>
