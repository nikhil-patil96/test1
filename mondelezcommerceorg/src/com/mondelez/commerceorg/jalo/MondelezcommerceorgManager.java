 ...
 */
package com.mondelez.commerceorg.jalo;
...
import com.mondelez.commerceorg.constants.MondelezcommerceorgConstants;



/**
 * This is the extension manager of the Mondelezcommerceorg extension.
 */
public class MondelezcommerceorgManager extends GeneratedMondelezcommerceorgManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MondelezcommerceorgManager.class.getName());
	 ...
	 */
	public static MondelezcommerceorgManager getInstance()
	{
		return (MondelezcommerceorgManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MondelezcommerceorgConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MondelezcommerceorgManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MondelezcommerceorgManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MondelezcommerceorgManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MondelezcommerceorgManager called, current tenant: " + getTenant().getTenantID());
		}
	}
