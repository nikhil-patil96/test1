 ...
 */
package com.mondelez.secureportal.facades.impl;
...
import com.mondelez.secureportal.data.B2BRegistrationData;
import com.mondelez.secureportal.exceptions.CustomerAlreadyExistsException;
import com.mondelez.secureportal.facades.B2BRegistrationFacade;
import com.mondelez.secureportal.facades.B2BRegistrationWorkflowFacade;
import com.mondelez.secureportal.model.B2BRegistrationModel;
...
public class DefaultB2BRegistrationFacade implements B2BRegistrationFacade
{
	 ...
	 * 
	 * @see
	 * com.mondelez.secureportal.facades.B2BRegistrationFacade#register(com.mondelez.secureportal
	...
	public void register(final B2BRegistrationData data) throws CustomerAlreadyExistsException
	{
		...
		try
		{
			...
			final WorkflowTemplateModel workflowTemplate = workflowTemplateService
					.getWorkflowTemplateForCode(MondelezsecureportalConstants.Workflows.REGISTRATION_WORKFLOW);

			if (LOG.isDebugEnabled())
			{
				LOG.debug(String.format("Created WorkflowTemplateModell using name '%s'",
						MondelezsecureportalConstants.Workflows.REGISTRATION_WORKFLOW));
			}
