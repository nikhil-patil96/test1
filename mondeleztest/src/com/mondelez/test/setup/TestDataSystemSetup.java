 ...
 */
package com.mondelez.test.setup;
...
import com.mondelez.test.constants.MondelezTestConstants;
import com.mondelez.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MondelezTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mondeleztest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mondeleztest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mondeleztest/import/cstickets.impex");
			...
			importImpexFile(context, "/mondeleztest/import/csquotes.impex");
		}
	}
}
