 ...
 */
package com.mondelez.cockpits.setup;
...
import com.mondelez.cockpits.constants.MondelezCockpitsConstants;
 ...
 */
@SystemSetup(extension = MondelezCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MondelezCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MondelezCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MondelezCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/mondelezcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
